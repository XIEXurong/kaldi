...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        "Average the rows of an input table of matrices and output the corresponding\n"
        "table of vectors\n"
        "\n"
        "Usage: matrix-average-rows [options] <matrix-rspecifier> <vector-wspecifier>\n"
        "e.g.: matrix-average-rows ark:- ark:- | vector-sum ark:- sum.vec\n"
    ...
    KALDI_LOG << "Averaged rows " << num_done << " matrices, "
