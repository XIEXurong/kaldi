...
KL=$2
decode_lat_dir=$3
version=_BLHUC_${layer_num}Layergap7_new_rt03_rnnlmplus${splitn}_KL${KL}_increase${tag}_batch${num_chunk}_epoch${epoch_num}_lr1${lr1}_lr2${lr2}
...
if [ -z $decode_lat_dir ]; then
	decode_lat_dir=cnn_tdnn_fbk_40_iv_1a_ep6_multijobs_sp/decode_rt03_fbk_40_sw1_fsh_fg_rnnlm_1e_back_large_drop_e40_0.45/1BEST_lat/score_10_0.0
fi

train_set=rt03_fbk_40_spk$splitn
...
if [ $stage -le 13 ]; then
  local/chain/train_adapt.py --stage $train_stage \
    --cmd "$train_cmd" \
	--feat.online-ivector-dir exp_kaldi_feats/nnet3/ivectors_rt03 \
...
if [ $stage -le 15 ]; then
  ...
  for decode_set in rt03_fbk_40_spk; do
      (
...
> $dir/scoring_all
grep Sum $dir/decode_rt03_fbk_40_spk_sw1_tg/score_*/*.ctm.swbd.filt.sys | utils/best_wer.sh >> $dir/scoring_all
grep Sum $dir/decode_rt03_fbk_40_spk_sw1_tg/score_*/*.ctm.fsh.filt.sys | utils/best_wer.sh >> $dir/scoring_all
grep Sum $dir/decode_rt03_fbk_40_spk_sw1_tg/score_*/*.ctm.filt.sys | utils/best_wer.sh >> $dir/scoring_all

grep Sum $dir/decode_rt03_fbk_40_spk_sw1_fg_arpa/score_*/*.ctm.swbd.filt.sys | utils/best_wer.sh >> $dir/scoring_all
grep Sum $dir/decode_rt03_fbk_40_spk_sw1_fg_arpa/score_*/*.ctm.fsh.filt.sys | utils/best_wer.sh >> $dir/scoring_all
grep Sum $dir/decode_rt03_fbk_40_spk_sw1_fg_arpa/score_*/*.ctm.filt.sys | utils/best_wer.sh >> $dir/scoring_all

grep Sum $dir/decode_rt03_fbk_40_spk_sw1_tg_htk_arpa/score_*/*.ctm.swbd.filt.sys | utils/best_wer.sh >> $dir/scoring_all
grep Sum $dir/decode_rt03_fbk_40_spk_sw1_tg_htk_arpa/score_*/*.ctm.fsh.filt.sys | utils/best_wer.sh >> $dir/scoring_all
grep Sum $dir/decode_rt03_fbk_40_spk_sw1_tg_htk_arpa/score_*/*.ctm.filt.sys | utils/best_wer.sh >> $dir/scoring_all

grep Sum $dir/decode_rt03_fbk_40_spk_sw1_fsh_fg/score_*/*.ctm.swbd.filt.sys | utils/best_wer.sh >> $dir/scoring_all
grep Sum $dir/decode_rt03_fbk_40_spk_sw1_fsh_fg/score_*/*.ctm.fsh.filt.sys | utils/best_wer.sh >> $dir/scoring_all
grep Sum $dir/decode_rt03_fbk_40_spk_sw1_fsh_fg/score_*/*.ctm.filt.sys | utils/best_wer.sh >> $dir/scoring_all
