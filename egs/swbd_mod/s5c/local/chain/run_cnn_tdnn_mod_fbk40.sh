...
if [ $stage -le 12 ]; then
  ...
  combine-feature-maps-layer name=combine_inputs input=Append(input-batchnorm, ivector-batchnorm) num-filters1=1 num-filters2=5 height=40
...
#    --cmd "queue.pl --config /home/dpovey/queue_conly.conf" \
  ...
  steps/nnet3/chain/train${train_par}.py --stage $train_stage \
    ...
    --feat.online-ivector-dir exp/nnet3/ivectors_${train_set}$suffix \
    ...
    --feat-dir data/${train_set}${suffix}_fbk_40 \
    --tree-dir $treedir \
