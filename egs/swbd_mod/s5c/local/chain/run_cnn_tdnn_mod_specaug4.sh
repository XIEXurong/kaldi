...
remove_egs=false
common_egs_dir=exp/chain/tdnn7r_sp/egs
xent_regularize=0.1
...
if [ $stage -le 12 ]; then
  ...
  simple-component name=idct-batchnorm-specmask type=SpecMaskOnlineComponent dim=40 opts="dim=40 rate-time-max=0.3 mask-prob=0.8 mask-as-mean=false width-time-max=1000"
  combine-feature-maps-layer name=combine_inputs input=Append(idct-batchnorm-specmask, ivector-batchnorm) num-filters1=1 num-filters2=5 height=40
