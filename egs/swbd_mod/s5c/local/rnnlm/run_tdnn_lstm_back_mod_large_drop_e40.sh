...
dir=exp/rnnlm/rnnlm_lstm_1e_backward_large_drop_e40
embedding_dim=1024
affine_dim=2048
cell_dim=2048
lstm_rpd=512
...
if [ $stage -le 4 ] && $run_lat_rescore; then
  ...
  for decode_set in eval2000_hires; do
    ...
    rnnlm/lmrescore_back.sh \
      ...
      data/lang_$LM $dir \
      ../s5c_new/data/${decode_set} ${decode_dir}_${decode_dir_suffix_forward}_0.45 \
      ${decode_dir}_${decode_dir_suffix_backward}_0.45
	
	> ${decode_dir}_${decode_dir_suffix_backward}_0.45/scoring_all
	grep Sum ${decode_dir}_${decode_dir_suffix_backward}_0.45/score_*/*.ctm.swbd.filt.sys | utils/best_wer.sh >> ${decode_dir}_${decode_dir_suffix_backward}_0.45/scoring_all
	grep Sum ${decode_dir}_${decode_dir_suffix_backward}_0.45/score_*/*.ctm.callhm.filt.sys | utils/best_wer.sh >> ${decode_dir}_${decode_dir_suffix_backward}_0.45/scoring_all
	grep Sum ${decode_dir}_${decode_dir_suffix_backward}_0.45/score_*/*.ctm.filt.sys | utils/best_wer.sh >> ${decode_dir}_${decode_dir_suffix_backward}_0.45/scoring_all
  done
fi
