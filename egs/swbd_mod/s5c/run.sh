...
if [ $stage -le 0 ]; then
  local/swbd1_data_download.sh /home/hei/works/data/swbd/LDC97S62
...
if [ $stage -le 2 ]; then
  ...
  local/swbd1_data_prep.sh /home/hei/works/data/swbd/LDC97S62
...
if [ $stage -le 3 ]; then
  ...
  fisher_dirs="/home/hei/works/data/swbd/fe_03_p1_tran_LDC2004T19/fe_03_p1_tran/ /home/hei/works/data/swbd/fe_03_p2_tran_LDC2005T19/fe_03_p2_tran/"
...
if [ $stage -le 5 ]; then
  ...
  local/eval2000_data_prep.sh /home/hei/works/data/swbd/hub5e_00_LDC2002S09/hub5e_00 /home/hei/works/data/swbd/LDC2002T43
fi

if [ $stage -le 6 ]; then
  # prepare the rt03 data.  Note: this isn't 100% necessary for this
  # recipe, not all parts actually test using rt03.
  local/rt03_data_prep.sh /home/hei/works/data/swbd/rt_03_LDC2007S10/rt_03
fi
