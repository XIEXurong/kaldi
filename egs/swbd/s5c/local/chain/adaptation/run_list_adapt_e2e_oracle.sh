...
bash local/chain/adaptation/generate_1best_lat_all_oracle.sh --tag "_eval2000" exp/chain/e2e_cnn_tdnnf_1a_iv_bi_specaugkaldi data/eval2000_hires exp/nnet3/ivectors_eval2000 data/lang_sw1_fsh_fg
...
bash local/chain/adaptation/LHUC/BLHUC_adaptation_mmi.sh \
 ...
 eval2000_hires_spk \
 exp/chain/e2e_cnn_tdnnf_1a_iv_bi_specaugkaldi/align_oracle_eval2000/1BEST_lat \
 eval2000_hires_spk


for decode_set in eval2000_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bi_specaugkaldi_BLHUC_eval2000_oracle_adaptlayer7_actSig_batch64_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
...
bash local/rnnlm/run_rescore_new.sh --lattice-prune-beam 6 --ngram_order 6 \
 ...
 "eval2000_hires_spk" exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bi_specaugkaldi_BLHUC_eval2000_oracle_adaptlayer7_actSig_batch64_epoch7_lr10.1_lr20.1
