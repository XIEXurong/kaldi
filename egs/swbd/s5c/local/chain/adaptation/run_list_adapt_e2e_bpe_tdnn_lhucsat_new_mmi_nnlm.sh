...
for decode_set in eval2000_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_bpe3g_mmice_SAT_LHUC_l1_LHUC_e2e_eval2000_e2ehires_mmice_transformer_adaptlayer14_actSig_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
...
bash local/pytorchnn/run_nnlm_decode_mod.sh --use_gpu true --use-nbest true \
 ...
 "eval2000_hires_spk" exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_bpe3g_mmice_SAT_LHUC_l1_LHUC_e2e_eval2000_e2ehires_mmice_transformer_adaptlayer14_actSig_epoch7_lr10.1_lr20.1
...
for decode_set in rt03_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_bpe3g_mmice_SAT_LHUC_l1_LHUC_e2e_rt03_e2ehires_mmice_transformer_adaptlayer14_actSig_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
...
bash local/pytorchnn/run_nnlm_decode_mod.sh --use_gpu true --use-nbest true \
 --LM-path data/lang_bpe_ --LM sw1_fsh_fg --other_opt '--gpu_wait true --limit_num_gpus_cmd "\"\""' \
 "rt03_hires_spk" exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_bpe3g_mmice_SAT_LHUC_l1_LHUC_e2e_rt03_e2ehires_mmice_transformer_adaptlayer14_actSig_epoch7_lr10.1_lr20.1
...
for decode_set in eval2000_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_bpe3g_mmice_SAT_LHUC_l1_BLHUC_e2e_eval2000_e2ehires_mmice_transformer_adaptlayer14_actSig_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
...
bash local/pytorchnn/run_nnlm_decode_mod.sh --use_gpu true --use-nbest true \
 --LM-path data/lang_bpe_ --LM sw1_fsh_fg --other_opt '--gpu_wait true --limit_num_gpus_cmd "\"\""' \
 "eval2000_hires_spk" exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_bpe3g_mmice_SAT_LHUC_l1_BLHUC_e2e_eval2000_e2ehires_mmice_transformer_adaptlayer14_actSig_epoch7_lr10.1_lr20.1
...
for decode_set in rt03_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_bpe3g_mmice_SAT_LHUC_l1_BLHUC_e2e_rt03_e2ehires_mmice_transformer_adaptlayer14_actSig_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
...
bash local/pytorchnn/run_nnlm_decode_mod.sh --use_gpu true --use-nbest true \
 --LM-path data/lang_bpe_ --LM sw1_fsh_fg --other_opt '--gpu_wait true --limit_num_gpus_cmd "\"\""' \
 "rt03_hires_spk" exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_bpe3g_mmice_SAT_LHUC_l1_BLHUC_e2e_rt03_e2ehires_mmice_transformer_adaptlayer14_actSig_epoch7_lr10.1_lr20.1
