...
for decode_set in eval2000 rt03; do
    lab_dir=exp/chain/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi/decode_${decode_set}_sw1_fsh_fg_rnnlm_1e_back_large_drop_e40_0.456_6_0graph_pytorch_crossutt100_transformer_20best_0.5/1BEST_fst/score_10_0.0
...
for subN in _sub5 _sub10 _sub20 _sub40; do
    ...
    for decode_set in eval2000_hires_spk; do
        for lm in tg fsh_fg; do
            dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_LHUC_e2e_eval2000${subN}_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
    ...
    bash local/pytorchnn/run_nnlm_decode_mod.sh --use_gpu true --use-nbest true --nbest_num 200 --cross_utt true --seq_len 100 --reset_history true \
     ...
     "eval2000_hires_spk" exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_LHUC_e2e_eval2000${subN}_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01
    ...
    bash local/chain/nnlmlat_pynnlm_rescore_crossutt.sh --use_gpu true --seq_len 100 \
     ...
     exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_LHUC_e2e_eval2000${subN}_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01 data/lang_bpe_sw1_fsh_fg \
...
for subN in _sub5 _sub10 _sub20 _sub40; do
    ...
    for decode_set in rt03_hires_spk; do
        for lm in tg fsh_fg; do
            dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_LHUC_e2e_rt03${subN}_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
            bash compute_score.sh $dir >> $dir/../scoring_all
        done
    done
    ...
    bash local/pytorchnn/run_nnlm_decode_mod.sh --use_gpu true --use-nbest true --nbest_num 200 --cross_utt true --seq_len 100 --reset_history true \
     ...
     --decode_dir_suffix pytorch_crossutt100_lstm_dim2048_drop15 --pytorch-path exp/pytorchnn_lm/pytorch_lstm_dim2048_drop15 \
     --model-type LSTM --embedding-dim 1024 --hidden-dim 2048 --nlayers 2 --tied false \
     "rt03_hires_spk" exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_LHUC_e2e_rt03${subN}_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01
    ...
    bash local/chain/nnlmlat_pynnlm_rescore_crossutt.sh --use_gpu true --seq_len 100 \
     --N 20 --weight 0.5 --py_nnlm_tag pytorch_crossutt100_transformer --py_nnlm exp/pytorchnn_lm/pytorch_transformer --LM_path data/lang_bpe_ \
     exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_LHUC_e2e_rt03${subN}_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01 data/lang_bpe_sw1_fsh_fg \
...
for subN in _sub5 _sub10 _sub20 _sub40; do
    ...
    for decode_set in eval2000_hires_spk; do
        for lm in tg fsh_fg; do
            dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_BLHUC_e2e_eval2000${subN}_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
            bash compute_score.sh $dir >> $dir/../scoring_all
        done
    done
    ...
    bash local/pytorchnn/run_nnlm_decode_mod.sh --use_gpu true --use-nbest true --nbest_num 200 --cross_utt true --seq_len 100 --reset_history true \
     ...
     --decode_dir_suffix pytorch_crossutt100_lstm_dim2048_drop15 --pytorch-path exp/pytorchnn_lm/pytorch_lstm_dim2048_drop15 \
     --model-type LSTM --embedding-dim 1024 --hidden-dim 2048 --nlayers 2 --tied false \
     "eval2000_hires_spk" exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_BLHUC_e2e_eval2000${subN}_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01
    ...
    bash local/chain/nnlmlat_pynnlm_rescore_crossutt.sh --use_gpu true --seq_len 100 \
     --N 20 --weight 0.5 --py_nnlm_tag pytorch_crossutt100_transformer --py_nnlm exp/pytorchnn_lm/pytorch_transformer --LM_path data/lang_bpe_ \
     exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_BLHUC_e2e_eval2000${subN}_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01 data/lang_bpe_sw1_fsh_fg \
     eval2000_hires_spk decode_eval2000_hires_spk_sw1_fsh_fg_pytorch_crossutt100_lstm_back_dim2048_drop15_200best_0.8
done
...
for subN in _sub5 _sub10 _sub20 _sub40; do
    ...
    for decode_set in rt03_hires_spk; do
        for lm in tg fsh_fg; do
            dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_BLHUC_e2e_rt03${subN}_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
            bash compute_score.sh $dir >> $dir/../scoring_all
        done
    done
    ...
    bash local/pytorchnn/run_nnlm_decode_mod.sh --use_gpu true --use-nbest true --nbest_num 200 --cross_utt true --seq_len 100 --reset_history true \
     ...
     --decode_dir_suffix pytorch_crossutt100_lstm_dim2048_drop15 --pytorch-path exp/pytorchnn_lm/pytorch_lstm_dim2048_drop15 \
     --model-type LSTM --embedding-dim 1024 --hidden-dim 2048 --nlayers 2 --tied false \
     "rt03_hires_spk" exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_BLHUC_e2e_rt03${subN}_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01
    ...
    bash local/chain/nnlmlat_pynnlm_rescore_crossutt.sh --use_gpu true --seq_len 100 \
     --N 20 --weight 0.5 --py_nnlm_tag pytorch_crossutt100_transformer --py_nnlm exp/pytorchnn_lm/pytorch_transformer --LM_path data/lang_bpe_ \
     exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_BLHUC_e2e_rt03${subN}_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01 data/lang_bpe_sw1_fsh_fg \
     rt03_hires_spk decode_rt03_hires_spk_sw1_fsh_fg_pytorch_crossutt100_lstm_back_dim2048_drop15_200best_0.8
done


result_file=exp/chain/adaptation/LHUC_e2e/results_e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_BLHUC_e2e_rnnlmpluspytfcrossutt_sub
> $result_file
for decode_set in eval2000 rt03; do
    echo "### ${decode_set}" >> $result_file
    for subN in _sub5 _sub10 _sub20 _sub40 ""; do
        echo "## ${subN}" >> $result_file
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_BLHUC_e2e_${decode_set}${subN}_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01
