...
bash local/chain/adaptation/generate_1best_fst_all.sh exp/chain/e2e_tdnnf_7r_iv_bi_mmice/decode_eval2000_sw1_fsh_fg
...
bash local/chain/adaptation/LHUC/LHUC_adaptation_e2e.sh \
 ...
 exp/chain/e2e_tdnnf_7r_iv_bi_mmice/decode_eval2000_sw1_fsh_fg/1BEST_fst/score_10_0.0 \
 eval2000_hires_spk

for decode_set in eval2000_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_iv_bi_mmice_LHUC_e2e_eval2000_e2ehires_mmice_adaptlayer14_actSig_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
...
bash local/chain/adaptation/generate_1best_fst_all.sh exp/chain/e2e_tdnnf_7r_iv_bi_mmice/decode_rt03_sw1_fsh_fg
...
bash local/chain/adaptation/LHUC/LHUC_adaptation_e2e.sh \
 ...
 --epoch-num 7 --lr1 0.1 --lr2 0.1 --param-init 0.0 \
 rt03_e2e_hires_spk \
 exp/chain/e2e_tdnnf_7r_iv_bi_mmice/decode_rt03_sw1_fsh_fg/1BEST_fst/score_10_0.0 \
 rt03_hires_spk

for decode_set in rt03_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_iv_bi_mmice_LHUC_e2e_rt03_e2ehires_mmice_adaptlayer14_actSig_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
...
for decode_set in eval2000_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_iv_bi_mmice_BLHUC_e2e_eval2000_e2ehires_mmice_adaptlayer14_actSig_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
...
for decode_set in rt03_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_iv_bi_mmice_BLHUC_e2e_rt03_e2ehires_mmice_adaptlayer14_actSig_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
