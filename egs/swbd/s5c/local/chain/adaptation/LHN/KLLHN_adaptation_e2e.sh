...
version=_KLLHN_e2e${tag}_adaptlayer${layer_num}_epoch${epoch_num}_lr1${lr1}_lr2${lr2}
...
cat <<EOF >> $dir/configs/change.config
    ...
    # P_SI
	component-node name=SI.tdnnf2.affine component=tdnnf2.affine input=tdnnf2.linear
	...
	component-node name=SI.tdnnf2.noop component=tdnnf2.noop input=Sum(Scale(0.66, tdnn1.dropout), SI.tdnnf2.dropout)
