...
bash local/chain/adaptation/LHUC/LHUC_adaptation_e2e.sh \
 ...
 exp/chain/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi/decode_eval2000_sw1_fsh_fg_pytorch_transformer_20best_0.8/1BEST_fst/score_10_0.0 \
 eval2000_hires_spk

for decode_set in eval2000_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_SAT_LHUC_l1_LHUC_e2e_eval2000_e2ehires_transformer_adaptlayer7_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
...
bash local/pytorchnn/run_nnlm_decode_mod.sh --use_gpu true --use-nbest true \
 ...
 "eval2000_hires_spk" exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_SAT_LHUC_l1_LHUC_e2e_eval2000_e2ehires_transformer_adaptlayer7_actSig_epoch7_lr10.01_lr20.01
...
bash local/chain/adaptation/LHUC/LHUC_adaptation_e2e.sh \
 ...
 --epoch-num 7 --lr1 0.01 --lr2 0.01 --param-init 0.0 \
 rt03_e2e_hires_spk \
 exp/chain/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi/decode_rt03_sw1_fsh_fg_pytorch_transformer_20best_0.8/1BEST_fst/score_10_0.0 \
 rt03_hires_spk

for decode_set in rt03_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_SAT_LHUC_l1_LHUC_e2e_rt03_e2ehires_transformer_adaptlayer7_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
...
bash local/pytorchnn/run_nnlm_decode_mod.sh --use_gpu true --use-nbest true \
 --LM-path data/lang_bpe_ --LM sw1_fsh_fg --other_opt '--gpu_wait true --limit_num_gpus_cmd "\"\""' \
 "rt03_hires_spk" exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_SAT_LHUC_l1_LHUC_e2e_rt03_e2ehires_transformer_adaptlayer7_actSig_epoch7_lr10.01_lr20.01
...
for decode_set in eval2000_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_SAT_LHUC_l1_BLHUC_e2e_eval2000_e2ehires_transformer_adaptlayer7_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
...
bash local/pytorchnn/run_nnlm_decode_mod.sh --use_gpu true --use-nbest true \
 --LM-path data/lang_bpe_ --LM sw1_fsh_fg --other_opt '--gpu_wait true --limit_num_gpus_cmd "\"\""' \
 "eval2000_hires_spk" exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_SAT_LHUC_l1_BLHUC_e2e_eval2000_e2ehires_transformer_adaptlayer7_actSig_epoch7_lr10.01_lr20.01
...
bash local/chain/nnlmlat_pynnlm_rescore_crossutt.sh --use_gpu true --seq_len 100 \
 ...
 exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_SAT_LHUC_l1_BLHUC_e2e_eval2000_e2ehires_transformer_adaptlayer7_actSig_epoch7_lr10.01_lr20.01 data/lang_bpe_sw1_fsh_fg \
...
for decode_set in rt03_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_SAT_LHUC_l1_BLHUC_e2e_rt03_e2ehires_transformer_adaptlayer7_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
...
bash local/pytorchnn/run_nnlm_decode_mod.sh --use_gpu true --use-nbest true \
 --LM-path data/lang_bpe_ --LM sw1_fsh_fg --other_opt '--gpu_wait true --limit_num_gpus_cmd "\"\""' \
 "rt03_hires_spk" exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_SAT_LHUC_l1_BLHUC_e2e_rt03_e2ehires_transformer_adaptlayer7_actSig_epoch7_lr10.01_lr20.01
...
bash local/chain/nnlmlat_pynnlm_rescore_crossutt.sh --use_gpu true --seq_len 100 \
 --N 20 --weight 0.5 --py_nnlm_tag pytorch_crossutt100_transformer --py_nnlm exp/pytorchnn_lm/pytorch_transformer --LM_path data/lang_bpe_ \
 exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bpe3g_mmice_specaugkaldi_SAT_LHUC_l1_BLHUC_e2e_rt03_e2ehires_transformer_adaptlayer7_actSig_epoch7_lr10.01_lr20.01 data/lang_bpe_sw1_fsh_fg \
