...
for decode_set in eval2000_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bi_mmice_specaugkaldi_LHUC_e2e_eval2000_e2ehires_oracle_mmice_adaptlayer7_actSig_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
...
bash local/pytorchnn/run_nnlm_decode_mod.sh --use_gpu true --use-nbest true --nbest_num 200 --cross_utt true --seq_len 100 --reset_history true \
 ...
 "eval2000_hires_spk" exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bi_mmice_specaugkaldi_LHUC_e2e_eval2000_e2ehires_oracle_mmice_adaptlayer7_actSig_epoch7_lr10.1_lr20.1
...
bash local/chain/nnlmlat_pynnlm_rescore_crossutt.sh --use_gpu true --seq_len 100 \
 ...
 exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bi_mmice_specaugkaldi_LHUC_e2e_eval2000_e2ehires_oracle_mmice_adaptlayer7_actSig_epoch7_lr10.1_lr20.1 data/lang_sw1_fsh_fg \
...
for decode_set in rt03_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bi_mmice_specaugkaldi_LHUC_e2e_rt03_e2ehires_oracle_mmice_adaptlayer7_actSig_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
...
bash local/pytorchnn/run_nnlm_decode_mod.sh --use_gpu true --use-nbest true --nbest_num 200 --cross_utt true --seq_len 100 --reset_history true \
 ...
 --decode_dir_suffix pytorch_crossutt100_lstm_dim2048_drop15 --pytorch-path exp/pytorchnn_lm/pytorch_lstm_dim2048_drop15 \
 --model-type LSTM --embedding-dim 1024 --hidden-dim 2048 --nlayers 2 --tied false \
 "rt03_hires_spk" exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bi_mmice_specaugkaldi_LHUC_e2e_rt03_e2ehires_oracle_mmice_adaptlayer7_actSig_epoch7_lr10.1_lr20.1
...
bash local/chain/nnlmlat_pynnlm_rescore_crossutt.sh --use_gpu true --seq_len 100 \
 --N 20 --weight 0.5 --py_nnlm_tag pytorch_crossutt100_transformer --py_nnlm exp/pytorchnn_lm/pytorch_transformer --LM_path data/lang_ \
 exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bi_mmice_specaugkaldi_LHUC_e2e_rt03_e2ehires_oracle_mmice_adaptlayer7_actSig_epoch7_lr10.1_lr20.1 data/lang_sw1_fsh_fg \
...
for decode_set in eval2000_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bi_mmice_specaugkaldi_BLHUC_e2e_eval2000_e2ehires_oracle_mmice_adaptlayer7_actSig_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
...
for decode_set in rt03_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bi_mmice_specaugkaldi_BLHUC_e2e_rt03_e2ehires_oracle_mmice_adaptlayer7_actSig_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
