...
bash local/chain/adaptation/generate_1best_fst_all_oracle.sh --tag "_eval2000" exp/chain/e2e_tdnnf_7r_iv_bi_mmice data/eval2000_hires_spk
...
bash local/chain/adaptation/LHUC/LHUC_adaptation_e2e.sh \
 ...
 exp/chain/e2e_tdnnf_7r_iv_bi_mmice/fst_oracle_eval2000/1BEST_fst \
 eval2000_hires_spk

for decode_set in eval2000_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_iv_bi_mmice_LHUC_e2e_eval2000_e2ehires_oracle_adaptlayer14_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
...
bash local/chain/adaptation/generate_1best_fst_all_oracle.sh --tag "_rt03" exp/chain/e2e_tdnnf_7r_iv_bi_mmice data/rt03_hires_spk
...
bash local/chain/adaptation/LHUC/LHUC_adaptation_e2e.sh \
 ...
 --epoch-num 7 --lr1 0.01 --lr2 0.01 --param-init 0.0 \
 rt03_e2e_hires_spk \
 exp/chain/e2e_tdnnf_7r_iv_bi_mmice/fst_oracle_rt03/1BEST_fst \
 rt03_hires_spk

for decode_set in rt03_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_iv_bi_mmice_LHUC_e2e_rt03_e2ehires_oracle_adaptlayer14_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
...
for decode_set in eval2000_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_iv_bi_mmice_BLHUC_e2e_eval2000_e2ehires_oracle_adaptlayer14_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
...
for decode_set in rt03_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_iv_bi_mmice_BLHUC_e2e_rt03_e2ehires_oracle_adaptlayer14_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
