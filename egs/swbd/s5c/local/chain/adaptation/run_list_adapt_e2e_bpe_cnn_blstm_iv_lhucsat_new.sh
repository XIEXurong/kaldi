...
for decode_set in eval2000_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnn_blstm_1a_iv_bpe3g_mmice_specaugkaldi_SAT1_LHUC_l1_LHUC_e2e_eval2000_e2ehires_adaptlayer7_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
...
bash local/chain/adaptation/LHUC/LHUC_adaptation_lstm_e2e.sh \
 ...
 --epoch-num 7 --lr1 0.01 --lr2 0.01 --param-init 0.0 \
 rt03_e2e_hires_spk \
 exp/chain/e2e_cnn_tdnn_blstm_1a_iv_bpe3g_mmice_specaugkaldi/decode_rt03_sw1_fsh_fg/1BEST_fst/score_10_0.0 \
 rt03_hires_spk

for decode_set in rt03_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnn_blstm_1a_iv_bpe3g_mmice_specaugkaldi_SAT1_LHUC_l1_LHUC_e2e_rt03_e2ehires_adaptlayer7_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
...
for decode_set in eval2000_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnn_blstm_1a_iv_bpe3g_mmice_specaugkaldi_SAT1_LHUC_l1_BLHUC_e2e_eval2000_e2ehires_adaptlayer7_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
...
for decode_set in rt03_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnn_blstm_1a_iv_bpe3g_mmice_specaugkaldi_SAT1_LHUC_l1_BLHUC_e2e_rt03_e2ehires_adaptlayer7_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
