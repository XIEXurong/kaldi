...
for decode_set in eval2000_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_iv_bpe3g_mmice_SAT_LHUC_l1_LHUC_e2e_eval2000_e2ehires_mmice_adaptlayer14_actSig_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
...
for decode_set in rt03_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_iv_bpe3g_mmice_SAT_LHUC_l1_LHUC_e2e_rt03_e2ehires_mmice_adaptlayer14_actSig_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
...
for decode_set in eval2000_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_iv_bpe3g_mmice_SAT_LHUC_l1_BLHUC_e2e_eval2000_e2ehires_mmice_adaptlayer14_actSig_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
...
for decode_set in rt03_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_tdnnf_7r_iv_bpe3g_mmice_SAT_LHUC_l1_BLHUC_e2e_rt03_e2ehires_mmice_adaptlayer14_actSig_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
