...
bash local/chain/adaptation/LHUC/BLHUC_adaptation.sh \
 ...
 eval2000_hires_spk \
 exp/chain/e2e_cnn_tdnnf_1a_iv_bi_mmice_specaugkaldi/decode_eval2000_sw1_fsh_fg/1BEST_lat/score_10_0.0 \
 eval2000_hires_spk

for decode_set in eval2000_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bi_mmice_specaugkaldi_BLHUC_eval2000_mmice_adaptlayer7_actSig_batch64_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
...
bash local/chain/adaptation/LHUC/BLHUC_adaptation.sh \
 ...
 --adapt-base adaptation/LHUC_e2e \
 rt03_hires_spk \
 exp/chain/e2e_cnn_tdnnf_1a_iv_bi_mmice_specaugkaldi/decode_rt03_sw1_fsh_fg/1BEST_lat/score_10_0.0 \
 rt03_hires_spk

for decode_set in rt03_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnnf_1a_iv_bi_mmice_specaugkaldi_BLHUC_rt03_mmice_adaptlayer7_actSig_batch64_epoch7_lr10.1_lr20.1/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
