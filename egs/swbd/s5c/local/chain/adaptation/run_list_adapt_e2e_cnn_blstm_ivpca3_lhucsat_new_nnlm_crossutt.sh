...
bash local/chain/adaptation/LHUC/BLHUC_adaptation_lstm_e2e.sh \
 --baseline e2e_cnn_tdnn_blstm_1a_ivpca3_bi_mmice_specaugkaldi_SAT1_LHUC_l1 \
...
for decode_set in eval2000_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnn_blstm_1a_ivpca3_bi_mmice_specaugkaldi_SAT1_LHUC_l1_BLHUC_e2e_eval2000_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
...
bash local/rnnlm/run_rescore_new.sh --lattice-prune-beam 6 --ngram_order 6 \
 ...
 "eval2000_hires_spk" exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnn_blstm_1a_ivpca3_bi_mmice_specaugkaldi_SAT1_LHUC_l1_BLHUC_e2e_eval2000_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01
...
bash local/chain/nnlmlat_pynnlm_rescore_crossutt.sh --use_gpu true --seq_len 100 \
 ...
 exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnn_blstm_1a_ivpca3_bi_mmice_specaugkaldi_SAT1_LHUC_l1_BLHUC_e2e_eval2000_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01 data/lang_sw1_fsh_fg \
...
for decode_set in rt03_hires_spk; do
    for lm in tg fsh_fg; do
        dir=exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnn_blstm_1a_ivpca3_bi_mmice_specaugkaldi_SAT1_LHUC_l1_BLHUC_e2e_rt03_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01/decode_${decode_set}_sw1_${lm}
        bash compute_score.sh $dir >> $dir/../scoring_all
    done
done
...
bash local/rnnlm/run_rescore_new.sh --lattice-prune-beam 6 --ngram_order 6 \
 ...
 --decode-dir-suffix-forward rnnlm_1e_large_drop_e40 \
 --decode-dir-suffix-backward rnnlm_1e_back_large_drop_e40 \
 "rt03_hires_spk" exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnn_blstm_1a_ivpca3_bi_mmice_specaugkaldi_SAT1_LHUC_l1_BLHUC_e2e_rt03_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01

bash local/chain/nnlmlat_pynnlm_rescore_crossutt.sh --use_gpu true --seq_len 100 \
 --N 20 --weight 0.5 --py_nnlm_tag pytorch_crossutt100_transformer --py_nnlm exp/pytorchnn_lm/pytorch_transformer --LM_path data/lang_ \
 exp/chain/adaptation/LHUC_e2e/e2e_cnn_tdnn_blstm_1a_ivpca3_bi_mmice_specaugkaldi_SAT1_LHUC_l1_BLHUC_e2e_rt03_e2ehires_rnnlmpluspytfcrossutt_adaptlayer7_actSig_epoch7_lr10.01_lr20.01 data/lang_sw1_fsh_fg \
