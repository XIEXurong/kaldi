...
cat <<EOF >> $dir/configs/change.config
    ...
    # P_SI
	component-node name=SI.tdnn1.batchnorm component=tdnn1.batchnorm input=tdnn1.relu
	component-node name=SI.tdnn1.dropout component=tdnn1.dropout input=SI.tdnn1.batchnorm
	component-node name=SI.tdnnf2.linear component=tdnnf2.linear input=SI.tdnn1.dropout
	component-node name=SI.tdnnf2.affine component=tdnnf2.affine input=SI.tdnnf2.linear
	component-node name=SI.tdnnf2.relu component=tdnnf2.relu input=SI.tdnnf2.affine
	component-node name=SI.tdnnf2.batchnorm component=tdnnf2.batchnorm input=SI.tdnnf2.relu
	component-node name=SI.tdnnf2.dropout component=tdnnf2.dropout input=SI.tdnnf2.batchnorm
	component-node name=SI.tdnnf2.noop component=tdnnf2.noop input=Sum(Scale(0.66, SI.tdnn1.dropout), SI.tdnnf2.dropout)
	component-node name=SI.tdnnf3.linear component=tdnnf3.linear input=SI.tdnnf2.noop
	component-node name=SI.tdnnf3.affine component=tdnnf3.affine input=SI.tdnnf3.linear
	component-node name=SI.tdnnf3.relu component=tdnnf3.relu input=SI.tdnnf3.affine
	component-node name=SI.tdnnf3.batchnorm component=tdnnf3.batchnorm input=SI.tdnnf3.relu
	component-node name=SI.tdnnf3.dropout component=tdnnf3.dropout input=SI.tdnnf3.batchnorm
	component-node name=SI.tdnnf3.noop component=tdnnf3.noop input=Sum(Scale(0.66, SI.tdnnf2.noop), SI.tdnnf3.dropout)
	component-node name=SI.tdnnf4.linear component=tdnnf4.linear input=SI.tdnnf3.noop
	component-node name=SI.tdnnf4.affine component=tdnnf4.affine input=SI.tdnnf4.linear
	component-node name=SI.tdnnf4.relu component=tdnnf4.relu input=SI.tdnnf4.affine
	component-node name=SI.tdnnf4.batchnorm component=tdnnf4.batchnorm input=SI.tdnnf4.relu
	component-node name=SI.tdnnf4.dropout component=tdnnf4.dropout input=SI.tdnnf4.batchnorm
	component-node name=SI.tdnnf4.noop component=tdnnf4.noop input=Sum(Scale(0.66, SI.tdnnf3.noop), SI.tdnnf4.dropout)
	component-node name=SI.tdnnf5.linear component=tdnnf5.linear input=SI.tdnnf4.noop
	component-node name=SI.tdnnf5.affine component=tdnnf5.affine input=SI.tdnnf5.linear
	component-node name=SI.tdnnf5.relu component=tdnnf5.relu input=SI.tdnnf5.affine
	component-node name=SI.tdnnf5.batchnorm component=tdnnf5.batchnorm input=SI.tdnnf5.relu
	component-node name=SI.tdnnf5.dropout component=tdnnf5.dropout input=SI.tdnnf5.batchnorm
	component-node name=SI.tdnnf5.noop component=tdnnf5.noop input=Sum(Scale(0.66, SI.tdnnf4.noop), SI.tdnnf5.dropout)
	component-node name=SI.tdnnf6.linear component=tdnnf6.linear input=SI.tdnnf5.noop
	component-node name=SI.tdnnf6.affine component=tdnnf6.affine input=SI.tdnnf6.linear
	component-node name=SI.tdnnf6.relu component=tdnnf6.relu input=SI.tdnnf6.affine
	component-node name=SI.tdnnf6.batchnorm component=tdnnf6.batchnorm input=SI.tdnnf6.relu
	component-node name=SI.tdnnf6.dropout component=tdnnf6.dropout input=SI.tdnnf6.batchnorm
	component-node name=SI.tdnnf6.noop component=tdnnf6.noop input=Sum(Scale(0.66, SI.tdnnf5.noop), SI.tdnnf6.dropout)
	component-node name=SI.tdnnf7.linear component=tdnnf7.linear input=SI.tdnnf6.noop
	...
	component-node name=SI.tdnnf7.noop component=tdnnf7.noop input=Sum(Scale(0.66, SI.tdnnf6.noop), SI.tdnnf7.dropout)
	component-node name=SI.tdnnf8.linear component=tdnnf8.linear input=SI.tdnnf7.noop
	...
	component-node name=SI.tdnnf8.noop component=tdnnf8.noop input=Sum(Scale(0.66, SI.tdnnf7.noop), SI.tdnnf8.dropout)
