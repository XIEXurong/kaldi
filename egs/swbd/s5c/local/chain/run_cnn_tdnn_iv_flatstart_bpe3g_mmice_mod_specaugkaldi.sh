...
train_stage=-10
get_egs_stage=-10
affix=1a_iv_bpe3g_mmice_specaugkaldi
...
if [ $stage -le 1 ]; then
  ...
  $train_cmd $treedir/log/make_phone_lm.log \
             ...
             data/lang_bpe \| \
             utils/sym2int.pl -f 2- data/lang_bpe/phones.txt \| \
             chain-est-phone-lm --num-extra-lm-states=2000 --ngram-order=3 --no-prune-ngram-order=2 \
