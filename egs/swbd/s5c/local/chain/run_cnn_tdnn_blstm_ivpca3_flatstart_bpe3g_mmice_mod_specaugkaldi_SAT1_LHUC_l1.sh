...
train_stage=-10
get_egs_stage=-10
affix=1a_ivpca3_bpe3g_mmice_specaugkaldi_SAT1_LHUC_l1
if [ -e data/rt03 ]; then maybe_rt03=rt03; else maybe_rt03= ; fi

baseline_model=exp/chain/e2e_cnn_tdnn_blstm_1a_ivpca3_bpe3g_mmice_specaugkaldi/60.mdl
  ...
  for decode_set in eval2000 $maybe_rt03; do
      ...
      if $has_fisher; then
          steps/lmrescore_const_arpa.sh --cmd "$decode_cmd" \
            data/lang_bpe_sw1_{tg,fsh_fg} data/${decode_set}_hires_spk \
