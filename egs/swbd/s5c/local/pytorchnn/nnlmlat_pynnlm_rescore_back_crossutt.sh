...
bash local/pytorchnn/run_nnlm_decode_back_mod.sh --cross_utt true --use_gpu $use_gpu --use-nbest true --LM_path $LM_path --LM $LM --other_opt '--gpu_wait true --stage 5 --limit_num_gpus_cmd "\"\""' --other_opt1 "$conv_conf" \
