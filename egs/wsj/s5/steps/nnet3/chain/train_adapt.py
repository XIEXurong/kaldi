...
import libs.nnet3.train.chain_objf.adaptation as adapt_lib
...
def get_args():
    ...
    parser.add_argument("--egs.deriv-weights-scp", type=str,
                        dest='deriv_weights_scp', default=None,
                        action=common_lib.NullstrToNoneAction,
                        help="""SCP file for derivative weights per frame.""")
    ...
    parser.add_argument("--trainer.optimization.initial-temperature",
                        type=float, dest='initial_temperature',
                        default=1.0,
                        help="Temperature used during the initial iteration in Gumbel")
    parser.add_argument("--trainer.optimization.final-temperature",
                        type=float, dest='final_temperature',
                        default=0.001,
                        help="Temperature used during the final iteration in Gumbel")
...
def train(args, run_opts):
    ...
    if ((args.stage <= -3) and args.egs_dir is None):
        ...
        adapt_lib.generate_chain_egs_adapt(
            ...
            srand=args.srand,
            deriv_weights_scp=args.deriv_weights_scp,
    ...
    for iter in range(num_iters):
        ...
        if args.stage <= iter:
            ...
            adapt_lib.train_one_iteration_adapt(
                dir=args.dir,
                iter=iter,
                srand=args.srand,
                egs_dir=egs_dir,
                ...
                learning_rate=lrate,
                temperature_edit_string=common_train_lib.get_temperature_edit_string(
