...
import libs.nnet3.train.chain_objf.train_parallel as chain_lib_par
...
def get_args():
    ...
    parser.add_argument("--free-memory-required", type=int,
                        dest='free_memory_required', default=7000,
                        help="""Free memory required in a gpu.""")
...
def train(args, run_opts):
    ...
    for iter in range(num_iters):
        ...
        if args.stage <= iter:
            ...
            chain_lib_par.train_one_iteration_parallel(
                dir=args.dir,
                iter=iter,
                srand=args.srand,
                egs_dir=egs_dir,
                ...
                frame_subsampling_factor=args.frame_subsampling_factor,
                free_memory_required=args.free_memory_required,
                run_opts=run_opts)
