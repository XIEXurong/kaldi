...
def get_input_and_target(args, hyps, vocab, history):
    ...
    return data, target, seq_lens, seq_lens_ori
    ...
    for idx, key in enumerate(sents.keys()):
        ...
        if args.reset_history:
            ...
            if spk != spk0:
                ...
                spk0 = spk
                print("Reset to "+spk0)
        data, targets, seq_lens, seq_lens_ori = get_input_and_target(args, sents[key], vocab, history)
